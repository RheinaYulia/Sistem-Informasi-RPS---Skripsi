...
use App\Models\Rps\StatusSahModel;
...
class StatusSahController extends Controller
{
    
    public function __construct(){
        $this->menuCode  = 'RPS.STATUSSAH';
        $this->menuUrl   = url('rps/status_sah');     // set URL untuk menu ini
        $this->menuTitle = 'Ajukan Pengesahan RPS';                       // set nama menu
        $this->viewPath  = 'rps.status_sah.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function list(Request $request){
        ...
        $data  = StatusSahModel::getStatusSah();
