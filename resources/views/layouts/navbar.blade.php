    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <div class="status_periode d-inline-block">
                @if($periode)
                    <button class="btn btn-light btn-sm mr-2"> /<span class="text-primary font-weight-bold"> <strong>{{ $periode->periode_name }} - {{ $periode->periode_semester }}</strong></span></button>
                @else
